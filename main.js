...
addEventListener('mousemove', e=>{ if(document.pointerLockElement===renderer.domElement){ state.camYaw -= e.movementX*0.0022; state.camPitch = THREE.MathUtils.clamp(state.camPitch - e.movementY*0.0015,-0.2,0.9); }});
